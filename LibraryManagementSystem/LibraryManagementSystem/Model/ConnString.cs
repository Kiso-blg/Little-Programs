...
namespace LibraryManagementSystem
{
    class ConnString
    {
        ...
        private const string DATABASE_NAME = "Library_Management_System_DB";
        ...
        {
            string filePath = AppDomain.CurrentDomain.BaseDirectory + "Library_Management_System_DB_SQLQuery.sql";
